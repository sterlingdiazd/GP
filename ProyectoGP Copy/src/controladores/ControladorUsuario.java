...
public class ControladorUsuario extends ConexionHeredada implements Mantenimientos {
	...
	try {	    
	  ...
	  while(rs.next()){
	      allUsers.add( new Usuario(  rs.getInt(Usuarios.IDUSUARIO.getText()), rs.getString(Usuarios.NOMBRE.getText()), rs.getString(Usuarios.APELLIDO.getText()), rs.getString(Usuarios.NOMBREUSUARIOS.getText()),
